...
malaria_deaths_map %>%
  ...
  coord_sf(expand = FALSE) +
  labs(
    title = "Global Malaria Deaths: All Ages, Across Countries and Time",
...
anim_save("africa_malaria_animation.gif", animation = animated_plot2, width = 6, height = 8, units = "in", res = 300, nframes = length(unique(africa_deaths_data$year)), fps = 10, renderer = magick_renderer(loop = FALSE))
```
